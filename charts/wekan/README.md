...
![Version: 0.3.0](https://img.shields.io/badge/Version-0.3.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v4.96](https://img.shields.io/badge/AppVersion-v4.96-informational?style=flat-square)
...
| envVars | object | `{"ROOT_URL":"https://wekan.domain.tld"}` | Pod environment variables |
